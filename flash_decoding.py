# adapted from
# https://github.com/ModelTC/lightllm/blob/90af2ab2104c516320c54d2bcd366321445064f7/lightllm/models/llama/triton_kernel/flash_decoding.py
# https://github.com/ModelTC/lightllm/blob/90af2ab2104c516320c54d2bcd366321445064f7/lightllm/models/llama/triton_kernel/flash_decoding_stage1.py
# https://github.com/ModelTC/lightllm/blob/90af2ab2104c516320c54d2bcd366321445064f7/lightllm/models/llama/triton_kernel/flash_decoding_stage2.py
...
@torch.no_grad()
def flash_decode_stage1(q, k, v, Req_to_tokens, B_req_idx, B_Seqlen, max_len_in_batch, mid_out, mid_out_logsumexp,
                        block_seq):
    BLOCK_SEQ = block_seq
    BLOCK_N = 16
...
def token_decode_attention_flash_decoding(q, cache_k, cache_v, out, mid_o, mid_o_logexpsum,
                                          req_to_token_indexs, b_req_idx, b_seq_len,
                                          batch_size, max_len_in_batch,
                                          q_head_num, head_dim, BLOCK_SEQ=256):
